class SpeechRecognizer {
  constructor() {
    ...
    this.apiKey = 'free'; // Featherless free tier
  ...
  toggleListening() {
    ...
    if (this.isListening) {
      ...
      this.transcript = '';
      this.detectedLanguage = null;
      this.recognition.lang = 'en-US'; // Always start with English
  ...
  async detectLanguageWithAPI(text) {
    try {
      // Using Featherless API for language detection
